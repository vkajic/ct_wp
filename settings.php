...
function cryptotask_register_theme_options_metabox() {
	...
	foreach ( $languages as $lang ) {
		$cmb_options->add_field( array(
			'name' => __( 'App URL ' . $lang['language_code'], 'cryptotask' ),
			'desc' => __( 'App frontend URL for ' . $lang['language_code'], 'cryptotask' ),
			'id'   => 'app_url_' . $lang['language_code'],
			'type' => 'text',
		) );
	}
